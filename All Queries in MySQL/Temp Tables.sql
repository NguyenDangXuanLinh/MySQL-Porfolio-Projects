...
-- They can be used to store intermediate results for complex queries or to manipulate data before 
-- inserting it into a permanent table.

-- There's 2 ways to create temp tables:
  -- 1. The less commonly used way, which is to build it exactly like a real table and insert data into it
...
-- now obviously it's balank so we would need to insert data into it like this:
...
-- if I'm just querying data and have some complex data I want to put into boxes or these temp tables to use later
